...
def main():
    ...
    no_of_weekend_nights = st.slider('Number of Weekend Nights', min_value=0, max_value=7)
    no_of_week_nights = st.slider('Number of Week Nights', min_value=0, max_value=20)
    ...
    repeated_guest = st.selectbox('Repeated Guess', [0, 1])
    no_of_previous_cancellations = st.slider('Number of Previous Cancellations', min_value=0, max_value=20)
